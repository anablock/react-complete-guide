...
* Spread - Allows you to extract all array element or objects
... - 
...
### Destructuring 
* Easily extract single array elements or object properties and store them in variables.  It is similar t Spread
...
### App scaffolding
* App.css and index.css apply global styling 

### Working with Props
When using class-based components, it is this.props:
```javascript
...
### Managing State
Initialize `State` by assigning it a value.  This value is a JavaScript object.
